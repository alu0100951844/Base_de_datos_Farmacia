...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Medicamento` (`cod_medicamento`, `cod_laboratorio`, `nombre_medicamento`, `precio_medicamento`, `stock`, `ventas_medicamento`, `receta`, `Tipo`) VALUES (0, 1, 'Paracetamol', 3, 2500, 3500, false, 'comprimido');
INSERT INTO `mydb`.`Medicamento` (`cod_medicamento`, `cod_laboratorio`, `nombre_medicamento`, `precio_medicamento`, `stock`, `ventas_medicamento`, `receta`, `Tipo`) VALUES (1, 1, 'Loratadina', 5, 7865, 4894, false, 'jarabe');
INSERT INTO `mydb`.`Medicamento` (`cod_medicamento`, `cod_laboratorio`, `nombre_medicamento`, `precio_medicamento`, `stock`, `ventas_medicamento`, `receta`, `Tipo`) VALUES (2, 2, 'Ibuprofeno', 5, 66699, 20000, true, 'comprimido');
INSERT INTO `mydb`.`Medicamento` (`cod_medicamento`, `cod_laboratorio`, `nombre_medicamento`, `precio_medicamento`, `stock`, `ventas_medicamento`, `receta`, `Tipo`) VALUES (3, 3, 'Bisolvon', 8, 7654, 34555, false, 'jarabe');
...
INSERT INTO `mydb`.`Compra` (`cod_factura`, `cod_medicamento`, `instante_compra`) VALUES (0, 1, '2018-06-01 8:30:23');
INSERT INTO `mydb`.`Compra` (`cod_factura`, `cod_medicamento`, `instante_compra`) VALUES (1, 2, '2018-11-03 20:46:10');
INSERT INTO `mydb`.`Compra` (`cod_factura`, `cod_medicamento`, `instante_compra`) VALUES (2, 3, '2018-01-22 23:23:48');
...
INSERT INTO `mydb`.`Factura` (`cod_factura`, `cod_medicamento`, `cantidad_comprada`) VALUES (0, 1, 1);
INSERT INTO `mydb`.`Factura` (`cod_factura`, `cod_medicamento`, `cantidad_comprada`) VALUES (1, 2, 3);
INSERT INTO `mydb`.`Factura` (`cod_factura`, `cod_medicamento`, `cantidad_comprada`) VALUES (2, 3, 3);
